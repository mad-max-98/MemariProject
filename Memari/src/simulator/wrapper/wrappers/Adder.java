...
public class Adder extends Wrapper {
    ...
    // first operand1 must be added then operand2 :: add =  operand1 + operand2
    // output pattern : 5 bit output  = [ Carry , output[ 3 : 0 ] ] 

    @Override
    public void initialize() {
    	//System.out.printf("this is Adder\n");
        ...
        * collections explicitly.*/
        ...
        //addOutput(fullAdders.get(fullAddersSize - 1).getOutput(0)); Carry is deleted
