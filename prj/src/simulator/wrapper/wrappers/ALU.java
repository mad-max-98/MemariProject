...
public class ALU extends Wrapper {
	...
	public void initialize() {
		...
		//:::: Multiplexers ::::
		//System.out.printf("this is After Nor\n");
		//ArrayList<Mux4x1> ALUmuxes =  new ArrayList<Mux4x1>() ;
		...
		for (int i = 0 ; i < 32 ; i++) {
			...
			//selectLines adding
			mux1.addInput(  ALU4input[2] ,ALU4input[3] );
			...
			//selectLines adding
			mux2.addInput( ALU4input[0] , ALU4input[3]  );
